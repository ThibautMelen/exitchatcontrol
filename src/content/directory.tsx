...
export const DIRECTORY: DirEntry[] = [
  ...
  { name: 'GPT4All', cat: 'ia-locale-agentique', license: 'MIT', href: 'https://gpt4all.io', fr: 'LLM locaux orientés vie privée, sur CPU.', en: 'Privacy-minded local LLMs, CPU-friendly.' },
  {
    ...
    license: 'AGPL-3.0',
    href: 'https://nika.sh',
    fr: 'Workflows IA en un binaire : le plan est un fichier relu avant exécution, permissions imposées, runs rejouables — modèles locaux (Ollama) ou cloud. (Divulgation : Nika est développé par SuperNovae Studio, dont le fondateur maintient ce guide.)',
    en: 'AI workflows in one binary: the plan is a file you review before it runs, permissions enforced, replayable runs — local models (Ollama) or cloud. (Disclosure: Nika is built by SuperNovae Studio, whose founder maintains this guide.)',
  },
